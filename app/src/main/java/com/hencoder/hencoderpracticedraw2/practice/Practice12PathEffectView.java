...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        PathEffect pathEffect2 = new DashPathEffect(new float[]{20,5,10,2},0);
        ...
        dashPath.rLineTo(50,50);
        dashPath.rLineTo(0,0);
        ...
        PathEffect discrete = new DiscretePathEffect(20,50);
        PathEffect pathEffect4 = new SumPathEffect(dash,discrete);
        ...
        PathEffect pathEffect5 = new ComposePathEffect(dash,discrete);
